...
export const skillTreeData: SkillBuild[] = [
  {
    ...
    nodes: [
      { id: 'root', x: 50, y: 1.5, displayState: 'available' },
      { id: 'left-a', x: 24, y: 22.5, displayState: 'unlocked' },
      { id: 'center-a', x: 50, y: 22.5, displayState: 'locked' },
      { id: 'right-a', x: 76, y: 22.5, displayState: 'locked' },
      { id: 'left-1', x: 13, y: 44.5, displayState: 'locked' },
      { id: 'left-2', x: 31, y: 44.5, displayState: 'locked' },
      { id: 'center-1', x: 43, y: 44.5, displayState: 'locked' },
      { id: 'center-2', x: 57, y: 44.5, displayState: 'locked' },
      { id: 'right-1', x: 69, y: 44.5, displayState: 'locked' },
      { id: 'right-2', x: 87, y: 44.5, displayState: 'locked' },
      { id: 'left-3', x: 24, y: 68, displayState: 'locked' },
      { id: 'left-4', x: 38, y: 68, displayState: 'locked' },
      { id: 'right-3', x: 69, y: 68, displayState: 'locked' },
      { id: 'right-4', x: 87, y: 68, displayState: 'locked' },
    ],
    connections: [
      { from: 'root', to: 'left-a' },
