...
export type Race = { id: string; name: string; selectionImage: string; displayImage: string; attributes: AttributeValues; resistances: Array<{ icon: string; value: string }>; description: string; symbolPosition: { top: string; left: string; size: string } }
export type CharacterClass = { id: string; name: string; image: string; symbol: string; attributes: Partial<AttributeValues> }

export const races: Race[] = [
  { id: 'human', name: 'Human', selectionImage: humanSelection, displayImage: humanDisplay, attributes: { health: 72, strength: 55, dexterity: 52, intelligence: 50, charisma: 58 }, resistances: [{ icon: '🔥', value: '5%' }, { icon: '❄', value: '8%' }, { icon: '☯', value: '10%' }, { icon: '♜', value: '6%' }], description: 'Versatile and determined, humans adapt quickly and find strength in every challenge.', symbolPosition: { top: '7%', left: '50%', size: '15%' } },
  { id: 'elf', name: 'Elf', selectionImage: elfSelection, displayImage: elfDisplay, attributes: { health: 64, strength: 42, dexterity: 78, intelligence: 68, charisma: 62 }, resistances: [{ icon: '🪨', value: '25%' }, { icon: '🔥', value: '5%' }, { icon: '❄', value: '15%' }, { icon: '♜', value: '13%' }], description: 'An innate leader with keen senses, elegant movement, and a gift for precision.', symbolPosition: { top: '7%', left: '50%', size: '15%' } },
  { id: 'dwarf', name: 'Dwarf', selectionImage: dwarfSelection, displayImage: dwarfDisplay, attributes: { health: 88, strength: 76, dexterity: 35, intelligence: 45, charisma: 38 }, resistances: [{ icon: '🪨', value: '30%' }, { icon: '🔥', value: '18%' }, { icon: '❄', value: '8%' }, { icon: '♜', value: '10%' }], description: 'Stout and unyielding, dwarves endure hardship and answer danger with raw power.', symbolPosition: { top: '7%', left: '50%', size: '14%' } },
  { id: 'orc', name: 'Orc', selectionImage: orcSelection, displayImage: orcDisplay, attributes: { health: 94, strength: 86, dexterity: 42, intelligence: 28, charisma: 34 }, resistances: [{ icon: '🪨', value: '35%' }, { icon: '🔥', value: '12%' }, { icon: '❄', value: '5%' }, { icon: '♜', value: '8%' }], description: 'Ferocious and resilient, orcs turn overwhelming force into a fighting advantage.', symbolPosition: { top: '7%', left: '50%', size: '16%' } },
]
