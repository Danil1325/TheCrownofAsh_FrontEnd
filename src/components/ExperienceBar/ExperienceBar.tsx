...
function ExperienceBar({ progression, onPreviewLevelUp }: ExperienceBarProps) {
  ...
  return (
    <section className="experience-bar" aria-label="Character experience">
      <div className="experience-bar__level">
        Level <strong>{progression.level}</strong>
      </div>
      <div
        className="experience-bar__track"
        role="progressbar"
        aria-valuemin={0}
        aria-valuemax={100}
      ...
      <div className="experience-bar__numbers">
        <b>{progression.currentExperience} EXP</b>
        <span>
      ...
      {onPreviewLevelUp && (
        <button className="experience-bar__preview" type="button" onClick={onPreviewLevelUp}>
          Test level up
        </button>
      )}
    </section>
